...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        up = PhotoImage(Image.open(FILEPATH + "/../images/up.png").resize((13, 13)))
        right = PhotoImage(Image.open(FILEPATH + "/../images/right.png").resize((13, 13)))
        left = PhotoImage(Image.open(FILEPATH + "/../images/left.png").resize((13, 13)))
        down = PhotoImage(Image.open(FILEPATH + "/../images/down.png").resize((13, 13)))
        rectangle = PhotoImage(Image.open(FILEPATH + "/../images/rectangle.png").resize((65, 65)))
        triangle = PhotoImage(Image.open(FILEPATH + "/../images/triangle.png").resize((65, 65)))
        circle = PhotoImage(Image.open(FILEPATH + "/../images/circle.png").resize((65, 65)))
